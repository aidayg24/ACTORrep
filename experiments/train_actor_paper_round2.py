"""
Train ACTOR on the paper-matched round-2 labeled pool.

Paper setting for HS-Brexit:
- initial labeled pool = 60
- query size = 60
- round-2 labeled pool = 180
- batch size = 32
- learning rate = 2e-5
- weight decay = 0.01
"""
...
# 1. Load datasets
# ---------------------------
train_path = "../processed_data/hsbrexit_paper_labeled_pool_round2.csv"
...
print("Paper round-2 labeled pool size:", len(train_df))
print("Dev size:", len(dev_df))
print("Test size:", len(test_df))

print("\nPaper round-2 label distribution:")
...
training_args = TrainingArguments(
    output_dir="../outputs/actor_paper_round2",
    eval_strategy="epoch",
    save_strategy="epoch",
...
# 11. Train
# ---------------------------
print("\nStarting training on paper round-2 pool...")
trainer.train()
