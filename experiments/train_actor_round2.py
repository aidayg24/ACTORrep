"""
Train ACTOR on the round-2 labeled pool.

What this script does
---------------------
This script trains the ACTOR model after two random acquisition rounds.

Training data:
- labeled pool after round 2 acquisition
...
# 1. Load datasets
# ---------------------------
train_path = "../processed_data/hsbrexit_labeled_pool_round2.csv"
...
print("Round-2 labeled pool size:", len(train_df))
print("Dev size:", len(dev_df))
print("Test size:", len(test_df))

print("\nRound-2 pool label distribution:")
...
training_args = TrainingArguments(
    output_dir="../outputs/actor_round2",
    eval_strategy="epoch",
    save_strategy="epoch",
...
# 11. Train
# ---------------------------
print("\nStarting training on round-2 labeled pool...")
trainer.train()
