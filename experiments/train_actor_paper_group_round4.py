"""
Train ACTOR on the paper group-entropy selected round-4 labeled pool.

This uses:
- labeled pool after paper round 3
- plus 60 newly selected samples from group-level entropy
"""
...
# 1. Load datasets
# ---------------------------
train_path = "../processed_data/hsbrexit_paper_group_labeled_pool_round4.csv"
...
print("Paper group round-4 labeled pool size:", len(train_df))
print("Dev size:", len(dev_df))
print("Test size:", len(test_df))

print("\nPaper group round-4 label distribution:")
...
training_args = TrainingArguments(
    output_dir="../outputs/actor_paper_group_round4",
    eval_strategy="epoch",
    save_strategy="epoch",
...
# 11. Train
# ---------------------------
print("\nStarting training on paper group round-4 pool...")
trainer.train()
