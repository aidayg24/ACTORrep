...
Purpose
-------
Round-4 active learning selection for the weighted ACTOR replication.

This script:
1. Loads the Round-3 weighted labeled pool and remaining unlabeled pool.
2. Loads the trained weighted ACTOR model from Round 3.
...
6. Saves the new Round-4 labeled and unlabeled pools.

Why this script exists
----------------------
We are continuing exactly the same weighted group-entropy active learning
pipeline that already worked for:
- Round 1
- Round 2
- Round 3
...
Outputs
-------
- ../processed_data/hsbrexit_paper_group_weighted_labeled_pool_round4.csv
- ../processed_data/hsbrexit_paper_group_weighted_unlabeled_pool_round4.csv
"""
...
LABELED_POOL_PATH = "../processed_data/hsbrexit_paper_group_weighted_labeled_pool_round3.csv"
UNLABELED_POOL_PATH = "../processed_data/hsbrexit_paper_group_weighted_unlabeled_pool_round3.csv"
MODEL_STATE_PATH = "../outputs/actor_paper_group_weighted_round3/actor_model_state.pt"

OUTPUT_LABELED_PATH = "../processed_data/hsbrexit_paper_group_weighted_labeled_pool_round4.csv"
OUTPUT_UNLABELED_PATH = "../processed_data/hsbrexit_paper_group_weighted_unlabeled_pool_round4.csv"
...
class ACTORModel(nn.Module):
    """
    Weighted ACTOR architecture compatible with the saved weighted checkpoints.

    Important:
    - keep attribute names compatible with the training scripts
    - annotator_heads must match saved checkpoint keys
    """
...
def infer_item_id_column(df: pd.DataFrame) -> str:
    ...
    We prefer item_id. If not found, try text_id.
    """
...
# Weighted checkpoints may contain extra keys not needed for acquisition
filtered_state_dict = {
