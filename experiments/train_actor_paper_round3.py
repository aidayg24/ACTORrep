"""
Train ACTOR on the paper-matched round-3 labeled pool.

Paper setting for HS-Brexit:
- initial labeled pool = 60
- query size = 60
- round-3 labeled pool = 240
- batch size = 32
- learning rate = 2e-5
- weight decay = 0.01
"""
...
# 1. Load datasets
# ---------------------------
train_path = "../processed_data/hsbrexit_paper_labeled_pool_round3.csv"
...
print("Paper round-3 labeled pool size:", len(train_df))
print("Dev size:", len(dev_df))
print("Test size:", len(test_df))

print("\nPaper round-3 label distribution:")
...
training_args = TrainingArguments(
    output_dir="../outputs/actor_paper_round3",
    eval_strategy="epoch",
    save_strategy="epoch",
...
# 11. Train
# ---------------------------
print("\nStarting training on paper round-3 pool...")
trainer.train()
...
# ---------------------------
# 13. Save trained ACTOR weights
# ---------------------------
torch.save(
    model.state_dict(),
    "../outputs/actor_paper_round3/actor_model_state.pt"
)

print("\nSaved trained ACTOR weights:")
print("../outputs/actor_paper_round3/actor_model_state.pt")