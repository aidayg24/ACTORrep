"""
Supervised ACTOR training for HS-Brexit.

What this script does
---------------------
This script implements the supervised ACTOR model on the HS-Brexit dataset.
...
The model routes each example through the corresponding annotator-specific head.

This script:
1. loads annotation-level data
2. maps annotators to integer IDs
3. tokenizes the text
4. defines the ACTOR multi-head model
5. trains the model in supervised mode
6. evaluates on dev and test sets

Important note
--------------
This is the supervised ACTOR stage only.
It does NOT yet include the active learning loop.
"""
...
# ---------------------------
# 1. Load annotation-level CSV splits
# ---------------------------
...
print("\nACTOR model created successfully.")
print("Number of annotator heads:", len(model.annotator_heads))
...
training_args = TrainingArguments(
    output_dir="../outputs/actor_supervised",
    eval_strategy="epoch",
    save_strategy="epoch",
...
# 11. Train
# ---------------------------
print("\nStarting ACTOR supervised training...")
trainer.train()
