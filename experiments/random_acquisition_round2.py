...
- save the updated round-2 pools
"""
...
# ---------------------------
labeled_path = "../processed_data/hsbrexit_labeled_pool_round1.csv"
unlabeled_path = "../processed_data/hsbrexit_unlabeled_pool_round1.csv"
...
random_state = 43   # different seed from round 1
...
# ---------------------------
updated_labeled_df.to_csv("../processed_data/hsbrexit_labeled_pool_round2.csv", index=False)
remaining_unlabeled_df.to_csv("../processed_data/hsbrexit_unlabeled_pool_round2.csv", index=False)

print("\nSaved:")
print("- ../processed_data/hsbrexit_labeled_pool_round2.csv")
print("- ../processed_data/hsbrexit_unlabeled_pool_round2.csv")