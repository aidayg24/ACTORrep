"""
Train ACTOR on the paper-matched round-1 labeled pool.

Paper setting for HS-Brexit:
- initial labeled pool = 60
- query size = 60
- round-1 labeled pool = 120
- batch size = 32
- learning rate = 2e-5
- weight decay = 0.01
"""
...
# 1. Load datasets
# ---------------------------
train_path = "../processed_data/hsbrexit_paper_labeled_pool_round1.csv"
...
print("Paper round-1 labeled pool size:", len(train_df))
print("Dev size:", len(dev_df))
print("Test size:", len(test_df))

print("\nPaper round-1 label distribution:")
...
training_args = TrainingArguments(
    output_dir="../outputs/actor_paper_round1",
    eval_strategy="epoch",
    save_strategy="epoch",
...
# 11. Train
# ---------------------------
print("\nStarting training on paper round-1 pool...")
trainer.train()
